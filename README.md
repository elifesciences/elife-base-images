...
- [unified docker PHP image repository](https://github.com/elifesciences/elife-base-images/pkgs/container/php) (with tags for `7.1-cli`, `7.1-fpm`, `7.3-cli`, `7.3-fpm`, `7.4-cli`, `7.4-fpm`, `8.0-cli`, `8.0-fpm`, `8.1-cli`, `8.1-fpm`, `8.2-cli`, `8.2-fpm`, `8.3-cli`, `8.3-fpm`, `8.4-cli`, `8.4-fpm`, `8.5-cli` and `8.5-fpm)`
